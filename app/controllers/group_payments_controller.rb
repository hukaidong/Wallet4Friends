class GroupPaymentsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @group_payment.save
        format.html { redirect_to @group_payment, notice: "Group payment was successfully created." }
  ...
  def update
    respond_to do |format|
      if @group_payment.update(group_payment_params)
        format.html { redirect_to @group_payment, notice: "Group payment was successfully updated." }
  ...
  def group_payment_params
    params.require(:group_payment).permit(:memo)
  end
end
